...
<li class="">
                    ...
                    <ul>
                        <li><a href="ComplaintType.php">Complaint</a></li>
                        <li><a href="Type.php">Count</a></li>
                    </ul>
</li>
<li class="">
                    <a   class="has-arrow" href="#" aria-expanded="false">
                    ...
                    <ul>
                        <li><a href="NewManager.php">New</a></li>
                        <li><a href="ManagerList.php">List</a></li>
                    </ul>
</li>
<li class="">
                    <a   class="has-arrow" href="#" aria-expanded="false">
                    ...
                    <ul>
                        <li><a href="NewTurf.php">New</a></li>
                        <li><a href="TurfList.php">List</a></li>
                        <li><a href="AssignTurf.php">Assign</a></li>
                    </ul>
</li>
<li class="">
                    <a   class="has-arrow" href="#" aria-expanded="false">
