                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <?php
	$i=0;
	  $sel = "select * from tbl_manager m inner join tbl_place p on p.place_id=m.place_id inner join tbl_district d on d.district_id=p.district_id";
	  $row = mysql_query($sel);
	  while($data = mysql_fetch_array($row))
	  {
		  ...
		  ?>  
											...
											<td align="center"><?php echo $data['manager_contact']; ?></td>
