...
<html>
    ...
    <?php      if (isset($_POST["btn_save"])) {
            ...
            $upQry = "update tbl_complaint set complaint_status='1',complaint_reply='" . $_POST["txt_reply"] . "' where complaint_id='" .$_POST["hid"]. "'";
            mysql_query($upQry);
                            ...
                            <div class="QA_section">
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <?php                                                $i = 0;
                                                $selQry = "select * from tbl_complaint c inner join tbl_complainttype ct on c.complainttype_id=ct.complainttype_id inner join tbl_user u on u.user_id=c.user_id  where complaint_status = '0'";
